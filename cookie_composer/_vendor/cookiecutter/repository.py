...
from cookie_composer._vendor.cookiecutter.exceptions import RepositoryNotFound
from cookie_composer._vendor.cookiecutter.vcs import clone
from cookie_composer._vendor.cookiecutter.zipfile import unzip

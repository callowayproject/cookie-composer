...
def get_config(config_path):
    ...
    if not os.path.exists(config_path):
        raise ConfigDoesNotExistException("Config file {} does not exist.".format(config_path))
    ...
    with open(config_path, encoding="utf-8") as file_handle:
        try:
            ...
            raise InvalidConfiguration("Unable to parse YAML file {}.".format(config_path)) from e

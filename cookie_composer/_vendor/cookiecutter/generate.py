...
from cookie_composer._vendor.cookiecutter.environment import StrictEnvironment
...
from cookie_composer._vendor.cookiecutter.find import find_template
from cookie_composer._vendor.cookiecutter.hooks import run_hook
from cookie_composer._vendor.cookiecutter.utils import (
    ...
    for variable, overwrite in overwrite_context.items():
        ...
        if isinstance(context_value, list):
            ...
            if overwrite in context_value:
                ...
                # see ``cookie_composer._vendor.cookiecutter.prompt.prompt_choice_for_config``
...
def generate_context(context_file="cookiecutter.json", default_context=None, extra_context=None):
    ...
    try:
        ...
        our_exc_message = 'JSON decoding error while loading "{0}".  Decoding' ' error details: "{1}"'.format(
